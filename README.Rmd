...
A catchy representation of humidity time series can be plotted, for instance, by using the library [echarts4r](<https://echarts4r.john-coene.com/>) by John Coene:
